...
#define ORIGINAL_FILE_NAME "UE4Editor-Musashi_project.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Musashi_project
#define DEPRECATED_FORGAME DEPRECATED
#define MUSASHI_PROJECT_API DLLEXPORT
